...
app.get("/createFaceGroup", function(req, res){
...
app.get("/listAllPerson", function(req, res){
  listAllPerson(res);
});
...
app.post("/addFace", upload.single("photo"), function(req, res){
...
app.post("/identify", upload.single("photo"), function(req, res){
  var buffer = new Buffer(req.file.buffer);
  uploadFile(buffer, res);
